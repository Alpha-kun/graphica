...
public class WeightedDiGraph extends AbstractGraph {

  ArrayList<WeightedDiEdge> edges;
  ArrayList<ArrayList<WeightedDiEdge>> adjList;

  int N;
  int E;
  public WeightedDiGraph() {
    vertices = new ArrayList<Vertex>();
    edges = new ArrayList<WeightedDiEdge>();
    adjList = new ArrayList<ArrayList<WeightedDiEdge>>();
  } 

  @Override
    synchronized void addV(int x, int y) {
    vertices.add(new Vertex(x, y, N++));
    adjList.add(new ArrayList<WeightedDiEdge>());
  }
  ...
  @Override
    ...
    WeightedDiEdge toBeRemoved=null;
  ...
  @Override
    ...
    println("a weighted digraph is dead");
  }
